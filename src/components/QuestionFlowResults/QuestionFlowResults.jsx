  ...
  return (<div>
    <div style={{display:'block', maxWidth: '350px', margin:'0 auto', textAlign: 'center'}}>
      <img
          ...
          src={
            tab.get() === 'map'
              ? 'https://d2ppvlu71ri8gs.cloudfront.net/items/3i3K071k3Q1e0j1A3e2R/Screen%20Shot%202017-05-16%20at%2013.15.45.png?v=d446acf2'
              : 'https://d2ppvlu71ri8gs.cloudfront.net/items/1m3Q3U3o02263K04470G/Image%202017-05-16%20at%201.13.37%20pm.png?v=3c947268'
          } />
