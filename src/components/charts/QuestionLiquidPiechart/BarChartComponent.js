...
class Bar extends React.Component {
  ...
  render() {
    const width = Math.round(
      (this.props.percentage * 0.7 * window.innerWidth) / 100
    );
    ...
    const display =
      this.state.direct_vote_count && window.innerWidth > 800
        ? `${this.props.full_name}....Direct vote count: ${
            this.state.direct_vote_count
          }`
